...
# Cria o violin plot
a = sns.violinplot(y=df_sem_outliers["valor"], inner="box", color="r")  # inner="box" adiciona um boxplot dentro do violino
...
# Cria o violin plot
b = sns.violinplot(y=df_sem_outliers["valor"], inner="box", color="b")  # inner="box" adiciona um boxplot dentro do violino
